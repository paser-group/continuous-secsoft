...
- Create a Python program that has the following functions/methods:
  ...
  - Item-3: Reporting precision and recall for the predicted classes using 10x10-fold cross validation
...
- Output of the classification result in a text file. The file must include data for precision and recall: 10%
