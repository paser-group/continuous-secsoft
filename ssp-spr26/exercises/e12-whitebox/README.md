...
- Submit your code, i.e., the modified `simple.py` file and the 10 collected error messages in a text file. 

### Rubric

- modified simple.py [50%]
- text file with error messages [50%] 