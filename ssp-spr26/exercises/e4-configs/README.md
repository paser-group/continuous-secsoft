...
## Tasks for You To Do
- `e4.zip` contains multiple Kubernetes manifests generated by ChatGPT. Run the tool for all Kubernetes manifests zipped in `e4.zip`. Show your execution in screenshots. You must yse the `NSA` framework. [30%] 
