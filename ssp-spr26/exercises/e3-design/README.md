...
- (T2) include at least one method/function that performs content extraction related to policy violations in regards to proper use of cryptography algorithms 
